...
# with open('pomFile', 'a', newline='') as f_object: 
...
#         writer_object.writerow(["<dependency>" + "<groupId>" + lSplit[0] + d + "</groupId>" + "<artifactId>" + lSplit[1] + "</artifactId>" + "<version>" + lSplit[3] + "</version>" + "<scope>main</scope>" + "</dependency>"]) 
